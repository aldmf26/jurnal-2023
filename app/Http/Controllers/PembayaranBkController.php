...
class PembayaranBkController extends Controller
{
    ...
    public function index(Request $r)
    {
        ...
        $draft = DB::select("SELECT a.tgl, a.no_nota, a.suplier_akhir, a.total_harga, a.lunas, c.kredit, c.debit
        FROM invoice_bk as a 
        ...
        $paid =  DB::select("SELECT a.tgl, a.no_nota, a.suplier_akhir, a.total_harga, a.lunas, c.kredit, c.debit
        FROM invoice_bk as a 
        ...
        $unpaid = DB::select("SELECT a.tgl, a.no_nota, a.suplier_akhir, a.total_harga, a.lunas, if(c.kredit is null , 0 ,c.kredit) as kredit, if(c.debit is null , 0,c.debit) as debit
        FROM invoice_bk as a 
