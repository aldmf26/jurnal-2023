<x-theme.app title="{{ $title }}" table="Y" sizeCard="12" cont="container-fluid">
    ...
    @endsection
</x-theme.app><x-theme.app title="{{ $title }}" table="Y" sizeCard="12" cont="container-fluid">
    <x-slot name="cardHeader">
        <div class="row justify-content-end">
            <div class="col-lg-6">
                <h6 class="float-start mt-1">{{ $title }} </h6>
            ...
            <div class="col-lg-6">
                <x-theme.button modal="Y" idModal="tambah" teks="Tambah Data" icon="fa-plus"
                    addClass="float-end" />
                <a href="{{ route('congan.export', ['tgl1' => $tgl1, 'tgl2' => $tgl2]) }}"
                    class="btn  btn-success float-end me-2 icon icon-left"><i class="fas fa-file-excel"></i>
                    Export</a>
                <x-theme.btn_filter title="Filter Pembelian Bk" />
            </div>
        </div>
